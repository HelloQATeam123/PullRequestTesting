...
- React class components with modern hooks refactoring
...
### `npm run build`
Creates an optimized production build in the `build` folder with minified files and hashed filenames ready for deployment.

### `npm run eject`
**Warning**: This is a one-way operation. Ejects from Create React App to expose all configuration files for full customization control.

## Technology Stack

### Core Technologies
- **React** - UI framework with class components and hooks
