...
- React class components and functional components with hooks
...
Ejects the application from Create React App, providing full control over configuration files and dependencies (webpack, Babel, ESLint, etc.). This is only recommended for advanced users who need custom configurations.
...
- **Firestore** - Cloud-based data storage and synchronization
...
**Built with React** | [Report Issues](https://github.com/HelloQATeam123/PullRequestTesting/issues)
