...
Ejects the application from Create React App, providing full control over configuration files and dependencies (webpack, Babel, ESLint, etc.). This is an advanced operation and should only be used when necessary.
...
### Framework
- **[Create React App](https://github.com/facebook/create-react-app)** - Build tooling and configuration
