...
### Production Build
The `npm run build` command creates an optimized production build in the `build` folder with:
...
- **[Create React App](https://github.com/facebook/create-react-app)** - Build toolchain
...
This application is deployed on [Vercel](https://vercel.com/) and can be accessed at [shopping-time.vercel.app](https://shopping-time.vercel.app/).
