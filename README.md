...
Ejects the application from Create React App, providing full control over configuration files and dependencies. Only use this if you need complete customization of the build configuration.
