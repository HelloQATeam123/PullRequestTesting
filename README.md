...
The build is minified and includes hashed filenames for cache optimization.  
See [deployment](https://facebook.github.io/create-react-app/docs/deployment) for more information.

### `npm run eject`
**Note: This is a one-way operation and cannot be reversed.**

Ejects from Create React App, providing full control over configuration files and dependencies. Only use if you need complete customization of the build configuration.
