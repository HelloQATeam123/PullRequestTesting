...
Ejects from Create React App, exposing all configuration files for full customization. Only use if you need complete control over the build configuration.
