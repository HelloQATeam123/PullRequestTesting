...
Ejects the project from Create React App, giving you full control over configuration files and dependencies. Only use this if you need complete customization control.
